...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_lottie__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! ngx-lottie */
    "./node_modules/ngx-lottie/__ivy_ngcc__/fesm2015/ngx-lottie.js");
    /* harmony import */


    var ngx_skeleton_loader__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ngx-skeleton-loader */
    "./node_modules/ngx-skeleton-loader/__ivy_ngcc__/fesm2015/ngx-skeleton-loader.js");
    /* harmony import */


    var lottie_web__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! lottie-web */
    "./node_modules/lottie-web/build/player/lottie.js");
    /* harmony import */


    var lottie_web__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(lottie_web__WEBPACK_IMPORTED_MODULE_29__);
    /* harmony import */


    var _drugstoc_web_product_product_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./drugstoc_web/product/product.component */
    "./src/app/drugstoc_web/product/product.component.ts");
    /* harmony import */


    var _drugstoc_web_my_drugstoc_my_drugstoc_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./drugstoc_web/my-drugstoc/my-drugstoc.component */
    "./src/app/drugstoc_web/my-drugstoc/my-drugstoc.component.ts");
    /* harmony import */


    var _drugstoc_web_my_orders_my_orders_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    /*! ./drugstoc_web/my-orders/my-orders.component */
    "./src/app/drugstoc_web/my-orders/my-orders.component.ts");
    /* harmony import */


    var _drugstoc_web_my_invoice_my_invoice_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
    /*! ./drugstoc_web/my-invoice/my-invoice.component */
    "./src/app/drugstoc_web/my-invoice/my-invoice.component.ts");
    /* harmony import */


    var _drugstoc_web_problem_problem_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    /*! ./drugstoc_web/problem/problem.component */
    "./src/app/drugstoc_web/problem/problem.component.ts");
    /* harmony import */


    var _drugstoc_web_profile_profile_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
    /*! ./drugstoc_web/profile/profile.component */
    "./src/app/drugstoc_web/profile/profile.component.ts");
    /* harmony import */


    var _drugstoc_web_promotions_promotions_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    /*! ./drugstoc_web/promotions/promotions.component */
    "./src/app/drugstoc_web/promotions/promotions.component.ts");
    /* harmony import */


    var angular_rave__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! angular-rave */
    "./node_modules/angular-rave/__ivy_ngcc__/fesm2015/angular-rave.js");
    /* harmony import */


    var angular_ng_autocomplete__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
    /*! angular-ng-autocomplete */
    "./node_modules/angular-ng-autocomplete/__ivy_ngcc__/fesm2015/angular-ng-autocomplete.js");
    /* harmony import */


    var _sweetalert2_ngx_sweetalert2__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
    ...
    var _drugstoc_web_cart_cart_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
    /*! ./drugstoc_web/cart/cart.component */
    "./src/app/drugstoc_web/cart/cart.component.ts");
    /* harmony import */


    var _drugstoc_web_per_products_per_products_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(
    /*! ./drugstoc_web/per-products/per-products.component */
    "./src/app/drugstoc_web/per-products/per-products.component.ts");
    /* harmony import */


    var ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(
    /*! ngx-infinite-scroll */
    ...
    var _drugstoc_web_per_category_per_category_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
    /*! ./drugstoc_web/per-category/per-category.component */
    "./src/app/drugstoc_web/per-category/per-category.component.ts");
    /* harmony import */


    var _drugstoc_web_per_category_list_per_category_list_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(
    ...
    var NavBar1Component = /*#__PURE__*/function () {
      ...
      _createClass(NavBar1Component, [{
        ...
        value: function search($event) {
          setTimeout(function () {
            window.location.reload();
          }, 100); // console.log($event.target.value)
    ...
    var CartComponent = /*#__PURE__*/function () {
      ...
      _createClass(CartComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.product.getProfile(this.userId).subscribe(function (res) {
            // console.log(res);
            _this4.dispatch.name = res['name'];
            _this4.dispatch.address = res['contact_address'];
            _this4.dispatch.phone = res['phone']; // console.log(this.dispatch, res)
          });
          this.cartData = this.product.getCatItem();
          console.log(this.cartData);
          this.product.updateCat(this.cartData).subscribe(function (res) {
            console.log(res);
          });
        }
      }, {
        ...
        key: "decreaseQty",
        value: function decreaseQty(item) {
          if (item.quantity > 0) {
            item.quantity -= 1;
        ...
        key: "increaseQty",
        value: function increaseQty(item) {
          item.quantity += 1;
          console.log(item); // this.product.editItemAQuantity()
        }
      }, {
        key: "removeItem",
  ...
  function srcAppDrugstoc_webPerCategoryPerCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PerCategoryComponent = /*#__PURE__*/function () {
      function PerCategoryComponent(product, toastr) {
    ...
    var SearchComponent = /*#__PURE__*/function () {
      ...
      _createClass(SearchComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.get_search(data); // setInterval(() => {
          ...
          setInterval(function () {
            console.log(_this19.route.snapshot.params.data);
            console.log(_this19.query === _this19.route.snapshot.params.data);
          }, 200); // if(this.query === this.route.snapshot.params.data) {
          // 	return;
          // } else {
          // }
        ...
        key: "get_search",
        value: function get_search(data) {
          var _this20 = this;
      ...
      _createClass(AuthService, [{
        ...
        value: function login(payload) {
          ...
          this.http.post("".concat(this.BASE_URL, "/login"), payload).subscribe(function (resp) {
            ...
            _this21.toastr.error(err.error.message);
        ...
        value: function register(payload) {
          return this.http.post("".concat(this.BASE_URL, "/register"), payload);
        }
      }, {
        key: "authenticated",
