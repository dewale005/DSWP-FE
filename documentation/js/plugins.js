...
(function ($) {
  ...
  !(function () {
    ...
    function i (t, i) {
      if (this.path = t || '', typeof i !== 'undefined' && i !== null) this.at_2x_path = i, this.perform_check = !1
      else {
    ...
    a.Retina = t, t.configure = function (t) {
      ...
      t.onload = function () {
        var t; var i; var a = document.getElementsByTagName('img')
        var r = []
    ...
    a.RetinaImagePath = i, i.confirmed_paths = [], i.prototype.is_external = function () {
      ...
      var e; var n = this
      return this.is_external() ? t(!1) : this.perform_check || typeof this.at_2x_path === 'undefined' || this.at_2x_path === null ? this.at_2x_path in i.confirmed_paths ? t(!0) : (e = new XMLHttpRequest(), e.open('HEAD', this.at_2x_path), e.onreadystatechange = function () {
        if (e.readyState !== 4) return t(!1)
        if (e.status >= 200 && e.status <= 399) {
          if (r.check_mime_type) {
            var a = e.getResponseHeader('Content-Type')
            if (a === null || !a.match(/^image/i)) return t(!1)
          }
      ...
      typeof t === 'undefined' && (t = this.path.at_2x_path)
      var i = this
      e()
    }, t.isRetina() && t.init(a)
  }())
